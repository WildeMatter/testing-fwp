                ...
                computed: {
                    ...
                    tableToDivs: function tableToDivs() {
                        ...
                        $(html).find('input, textarea, select').each(function() {
                            var $el = $(this);
                            var setting_name = $el.attr('class').replace(/-/g, '_').substr(6);
            ...
            FWP.vue = new Vue({
                ...
                methods: {
                    ...
                    saveChanges: function saveChanges() {
                        ...
                        // Settings save hook
                        var data = wp.hooks.applyFilters('facetwp/save_settings', FWP.data);
                        ...
                        if (false === bool) {
                            ['name', 'label', 'type'].forEach(function (key) {
                                if (obj.hasOwnProperty(key)) {
                                    if (obj[key].includes(this$1.keywords)) {
                                        bool = true;
                                    }
                                }
                            });
